...
namespace Clinika.Controllers
{
    public class ServiceCenterController : Controller
    {
        ...
        {
            servicecenter.Code = CodeGenaretor(servicecenter.Name);
        ...
        public string CodeGenaretor(string name)
        {
        ...
        public JsonResult ExistName(string name)
        {
            var centerName = db.ServiceCenters.FirstOrDefault(x => x.Name == name);
